...
function App() {
  ...
  const handleSpaceButtonClick = (spaced) => {
    ...
    const filteredBookings = new_bookings.filter(booking => booking.space === spaced);
 ...
 */
  ...
  return (
    ...
    <div>
      ...
      <table className="responsive-table"style={{ overflowX: 'scroll', tablelayout: 'fixed', width:'100%',marginTop: '2px', backgroundColor: '#499ca7', maxWidth: '100vw' }}>
